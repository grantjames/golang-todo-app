...
// 			r := app.makeHTTPRequest("/todos/")
// 			var todos map[string]types.Todo
// 			err := json.Unmarshal([]byte(r), &todos)
// 			if err != nil {
// 				slog.Error("Failed to unmarshal todos", "error", err.Error())
// 				continue
// 			}
// 			app.showTodos(todos)
...
// func (t *CLI) makeHTTPRequest(endpoint string) string {
// 	resp, err := http.Get(t.baseURL + endpoint)
// 	if err != nil {
...
// 	if err != nil {
// 		slog.Error("Failed to read HTTP response body", "error", err.Error())
// 		return ""
// 	}
